...
class Classify_by_eeoc
{
    ...
    public static function all()
    {
        ...
        $sql = "SELECT party_cl.id, party_cl.fromdate, party_cl.thrudate, party_cl.party_id, party_cl.party_type_id, ce.ethnicity_id, e.name_en, e.name_th
    ...
    {
        $pdo = self::getConnection();
        $sql1 = "INSERT INTO party_classification (
                fromdate, 
                thrudate, 
                party_id, 
                party_type_id)
        ...
        $sql3 = "INSERT INTO classify_by_eeoc (id, ethnicity_id)
                VALUES (:new_id, :ethnicity_id);";
        try {
            // execute sql ที่เตรียมไว้ ไปทีละตัว
    ...
    {
        $pdo = self::getConnection();
        $sql1 = "DELETE FROM public.classify_by_eeoc WHERE id = :id;";
        $sql2 = "DELETE FROM public.person_classification WHERE id = :id;";
        $sql3 = "DELETE FROM public.party_classification WHERE id = :id;";
