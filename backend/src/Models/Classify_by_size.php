...
class Classify_by_size
{
    ...
    public static function all()
    {
        ...
        $sql = "SELECT party_cl.id, party_cl.fromdate, party_cl.thrudate, party_cl.party_id, party_cl.party_type_id, cs.employee_count_range_id, ecr.description
...
VALUES (:id);";
        ...
        $sql3 = "INSERT INTO classify_by_size (id, employee_count_range_id)
VALUES (:id, :employee_count_range_id);";
        try {
            ...
            $stmt3->execute([
                'id' => $new_id,
                'employee_count_range_id' => $data['employee_count_range_id']
            ]);
...
WHERE id = :id;";
    ...
    {
        $pdo = self::getConnection();
        $sql1 = "DELETE FROM classify_by_size
WHERE id = :id;";
