...
class Citizenship
{
    ...
    public static function all()
    {
        ...
        $stmt = $pdo->query("SELECT * FROM public.citizenship order by id asc;");
    ...
    {
        $pdo = self::getConnection();
        $stmt = $pdo->prepare("SELECT * FROM public.citizenship WHERE id = :id");
        $stmt->execute(['id' => $id]);
        return $stmt->fetch();
    }
    ...
    {
        $pdo = self::getConnection();
        $stmt = $pdo->prepare("DELETE FROM public.citizenship WHERE id = :id");
        $stmt->execute(['id' => $id]);
