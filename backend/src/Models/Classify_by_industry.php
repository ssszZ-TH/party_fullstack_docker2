...
class Classify_by_industry
{
    ...
    public static function all()
    {
        ...
        $sql = "SELECT party_cl.id, party_cl.fromdate, party_cl.thrudate, party_cl.party_id, party_cl.party_type_id, ci.industry_type_id, it.naics_code, it.description
...
VALUES (:id);";
        ...
        $sql3 = "INSERT INTO classify_by_industry (id, industry_type_id)
VALUES (:id, :industry_type_id);";
    ...
    public static function update($id, $data)
    {
        ...
        $sql2 = "UPDATE classify_by_industry
    ...
    {
        $pdo = self::getConnection();
        $sql1 = "DELETE FROM classify_by_industry
WHERE id = :id;";
